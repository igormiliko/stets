...
const dots_dark = new SquareDots(
  comp_factory,
  "square-dots-container-dark"
).render("dk-grey");
const dots_light = new SquareDots(
  comp_factory,
  "square-dots-container-light"
).render("lh-grey")!;
...
await new Promise((r) => {
  dots_square_container
    .hug(
      dots_dark,
      dots_light.stylize("position")("absolute").stylize("top")("0px")
    )
    .stylize("position")("absolute")
    // .stylize("right")("152px")
    .xs(
      () =>
        dots_square_container.stylize("transform")("scale(0.3)").stylize("top")(
          "48vh"
        )
      // .stylize("right")("0px")
    )
    ...
    ?.lg(() =>
      dots_square_container
        .stylize("top")("50vh")
        ?.stylize("right")("20vw")
        .stylize("transform")("scale(0.6)")
    )
    ?.xl(() =>
      dots_square_container
        .stylize("top")("50vh")
        ?.stylize("right")("25vw")
        .stylize("transform")("scale(0.8)")
    );
  r(true);
});
//  component?.right('')
